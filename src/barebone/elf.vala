...
namespace Frida.Barebone {
	...
	// An image's zero-initialised data is not in the file, and an allocator hands out memory
	// as it finds it, so whatever the previous owner left behind has to go.
